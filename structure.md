# Структура хранения Data Hive

## Обзор архитектуры

Data Hive организован в виде иерархической файловой структуры для эффективного хранения и поиска контента. Основной принцип - разделение по пользователям с последующей категоризацией контента.

```
users/
└── lexey/                           # Пользовательская папка Data Hive
