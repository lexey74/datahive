...
• <b>Ссылки:</b>
  - Просто отправьте ссылку на YouTube или Instagram
...
• /rebuild_graph - Пересобрать graph.json из Knowledge.md и тегов
...
<b>🔧 4. Утилиты:</b>
• /status - Статус фоновых задач и health-check сервисов
